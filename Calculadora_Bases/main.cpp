...
#include <stdlib.h>
#include <locale.h>
//comando #define utilizado para definir o vetor binário com um tamanho = 41
#define tam 41
/* Codigo que realiza a conversão de um número, digitado pelo usuário, para as bases Decimal ou Binário.
 Autores: ANDRE CRESTANI
    CAIO HENRIQUE TENIUS
    GRÉGORI CABRAL DE NOVAES
    PAULO HENRIQUE DA SILVA
    THYAGO FERREIRA SIMÕES DE OLIVEIRA
Data: 19/04/2021
*/
...
int main(void)
{
    ...
    cout << "\n[0] - CANCELAR" <<endl;
    cout << "\n======================================" <<endl;
    cout << "\nDigite o valor correspondente a conversão que você deseja realizar:" << endl;
    ...
    switch(opcao){
        ...
        //o segundo caso se refere a conversão de um número binário em um número decimal, sendo que este número deve corresponder a 8bits, ou 1 Byte
        case 2:

                //Variaveis que serão utilizadas
                int numero,resultado, resto = 0;
                int digito[8];//Array que irá armazenar os bits digitados
                ...
                //esse operador serve para separa os bits em dígitos
                for(int i=0; i<8; i++){
                    digito[i] = numero % 10;
                    numero = numero / 10;
                }

                //esse operador irá realizar o cálculo para
                for(int i=7; i>=0; i--){
